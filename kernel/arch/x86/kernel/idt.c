...
void idt_init(void)
{
    ...
    idt_entry(12, (uintptr_t)ssflt,    __KERNEL_CS, 0, INT_GATE);
    idt_entry(13, (uintptr_t)gpflt,    __KERNEL_CS, 0, INT_GATE);
    idt_entry(14, (uintptr_t)pgflt,    __KERNEL_CS, 0, INT_GATE);
    idt_entry(16, (uintptr_t)flpexc,   __KERNEL_CS, 0, INT_GATE);
