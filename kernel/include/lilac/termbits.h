...
#define OLCUC    0x02            /* Map lowercase to uppercase on output */
#define ONLCR    0x04            /* Map NL to CR-NL on output */
#define OCRNL    0x08            /* Map CR to NL on output */
#define ONOCR    0x10            /* No CR output at column 0 */
#define ONLRET   0x20            /* NL performs CR function */
#define OFILL    0x40            /* Use fill characters for delay */
#define OFDEL    0x80            /* Fill is DEL, else NUL */
